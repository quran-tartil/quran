<form action="{{ $dataToEdit ? route('topicCategories.update', $dataToEdit->id) : route('topicCategories.store') }}" method="POST">
    @csrf
    ...
    <div class="card-body">
        <div class="form-group">
            <label for="name">{{ __('Quran/topicCategory/message.name') }} <span
